...
FURNIZOR_OPTIONS.append({"value": FURNIZOR_ADMIN_GLOBAL, "label": "Administrare integrare"})
...
class FluxConfigurareUtilitatiRomania(config_entries.ConfigFlow, domain=DOMENIU):
    ...
    async def async_step_user(self, user_input: dict[str, Any] | None = None) -> ConfigFlowResult:
        ...
        if user_input is not None:
            ...
            if self._furnizor == FURNIZOR_ADMIN_GLOBAL:
                return await self.async_step_admin_global()
    ...
    async def async_step_admin_global(
        ...
        return self.async_show_form(step_id="admin_global", data_schema=schema, errors=erori)
